...
def cli():
    ...
    parser.add_argument("--output_format", "-f", type=str, default="all", choices=["all", "srt", "vtt", "txt", "tsv", "json", "aud"], help="format of the output file; if not specified, all available formats will be produced. Multiple formats can be specified like this: --output_format srt vtt txt")
    ...
    if diarize:
        try:
            ...
            print("Error performing diarization, skipping...")
            print(e)
    # >> Write
